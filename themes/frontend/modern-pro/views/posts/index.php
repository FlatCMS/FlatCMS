...
<section class="section">
    <div class="container">
        ...
        <?php if (empty($posts['data'])): ?>
            <p class="posts-empty-text posts-empty-state-text"><?= __('no_posts', 'Posts') ?></p>
        <?php else: ?>
                    ...
                    <article class="card">
                        <div class="card-image">
                            <?php if (!empty($post['featured_image'])): ?>
                                <a href="<?= url('/' . $locale . '/blog/' . $post['slug']) ?>"><img src="<?= site_media_url($post['featured_image']) ?>" alt="<?= e($post['title']) ?>"></a>
                            <?php else: ?>
                        ...
                        <div class="card-body">
                            ...
                            <h2 class="card-title"><a href="<?= url('/' . $locale . '/blog/' . $post['slug']) ?>"><?= e($post['title']) ?></a></h2>
                            <?php
                            ...
                            <?php endif; ?>
                            <?php if (!empty($post['excerpt'])): ?><p class="card-excerpt"><?= e(str_limit($post['excerpt'], 120)) ?></p><?php endif; ?>
