...
<header class="page-header">
    <div class="container">
        <p class="meta post-header-meta"><?= human_date($post['created_at'], 'd M Y') ?></p>
        <h1><?= e($post['title']) ?></h1>
...
<div class="content-wrapper">
    <div class="container">
        ...
        <!-- Back to blog -->
        <div class="post-back-link-wrap">
            <a href="<?= url('/' . $locale . '/blog') ?>" class="btn btn-secondary">← <?= __('back_to_blog', 'Posts') ?></a>
        </div>
                    ...
                    <?php foreach ($comments as $comment): ?>
                        <div class="comment">
                            <div class="comment-header">
                                ...
                                <span class="comment-date"><?= human_date($comment['created_at'], 'd F Y H:i') ?></span>
                            </div>
                ...
                <form method="POST" action="<?= url('/comments') ?>">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="author_name" class="form-label"><?= __('your_name', 'Comments') ?> *</label>
                            <input type="text" id="author_name" name="author_name" class="form-input" autocomplete="name" required>
                        </div>
                        <div class="form-group">
                            <label for="author_email" class="form-label"><?= __('your_email', 'Comments') ?> *</label>
                            <input type="email" id="author_email" name="author_email" class="form-input" autocomplete="email" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="content" class="form-label"><?= __('your_comment', 'Comments') ?> *</label>
                        <textarea id="content" name="content" class="form-input" rows="5" autocomplete="on" required></textarea>
                    </div>
                ...
                <?php foreach ($relatedPosts as $related): ?>
                    ...
                    <article class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= $relatedUrl ?>" class="btn btn-sm btn-secondary"><?= __('read_more', 'Posts') ?> →</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
